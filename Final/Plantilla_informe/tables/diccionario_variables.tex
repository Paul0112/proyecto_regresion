...
log\_depth\_plus\_1 & Numérica transformada & log(depth + 1), calculado como log1p(depth.clip(lower=0)). & Especificación candidata y análisis de sensibilidad; no se adopta en el modelo final. \\
...
region\_from\_place & Categórica derivada & Región aproximada extraída desde el texto place. & Resumen geográfico categórico. \\
